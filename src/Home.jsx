...
const Home = () => {
    ...
    const handleDelete = (id) => {
        ...
        if (confirmDelete) {
          axios
            .delete('https://mock-api-bdg1.onrender.com/data/' + id)
            .then(() => {
    ...
    return (
        <Container fluid className='d-flex justify-content-center align-items-center flex-column flex-wrap'>
